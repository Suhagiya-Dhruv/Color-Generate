...
function run() {
    ...
    if (x == 'circle') {
        ...
        for (let count = 0; count < value; count++) {
            ...
            body += `<div class="column" style="background-image:radial-gradient(${x}, ${color1}, ${color2});
            height: 100px;"></div>`
            div.innerHTML = body;
        ...
        for (let count = 0; count < value; count++) {
            ...
            body += `<div class="column" style="background-image:linear-gradient(to ${x}, ${color1}, ${color2});
            height: 100px;"></div>`
            div.innerHTML = body;
            document.getElementById('input').value = '';
        }
